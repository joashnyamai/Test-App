    ...
    <ThemeContext.Provider value={{ theme, toggleTheme }}>
      ...
      >
        <div className="container mx-auto p-4 md:p-6 max-w-6xl">
          ...
          {/* Header */}
          <div
            className={`relative rounded-2xl p-6 md:p-8 mb-8 text-white overflow-hidden transition-all duration-300 ${
              theme === "dark"
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="flex items-center gap-6">
                ...
                <div className="relative group">
                  <div
                    className={`w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center text-2xl font-bold overflow-hidden transition-all duration-300 ${
                      theme === "dark"
          ...
          <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
            {tabs.map((tab) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors duration-300 whitespace-nowrap ${
                  activeTab === tab.id
                    ? theme === "dark"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {activeTab === "security" && (
              <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-2 pr-10 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                        placeholder="Enter new password"
                      />
                      <button
                        type="button"
                        className="absolute inset-y-0 right-0 top-5 flex items-center pr-3 text-gray-500 dark:text-gray-400"
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Security Status</h3>
                ...
                {editMode && (
                  <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button className="flex items-center gap-2 text-red-500 hover:text-red-700 transition-colors duration-300">
                      <Trash2 className="w-4 h-4" />
                      Delete Account
                    </button>
                  </div>
            ...
            {activeTab === "notifications" && (
              <div className="space-y-4">
                ...
                <div className="space-y-4 p-4 rounded-lg bg-gray-100 dark:bg-gray-700">
                  <ToggleSwitch
                ...
                {editMode && (
                  <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button className="text-sm text-purple-600 dark:text-purple-400 hover:underline transition-colors duration-300">
  ...
  <div className={className}>
    ...
    <div className="relative">
      ...
      <input
        ...
        className={`w-full py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${
...
const VerifyStatus = ({ 
  ...
  <div className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-gray-600 shadow-sm">
    <div>
